...
| **compgen**                      | Генератор автодополнения для команд                                      |
...
| **ncdu** / **dua**               | Использование дисков с интерактивным интерфейсом                         |
| **du** / **dust**                | Оценка размера файлов                                                    |
| **file**                         | Определение типа файла                                                   |
| **stat**                         | Информация о статусе файлов                                              |
...
| **mktemp**                       | Создаёт временную директорию                                             |
| **rmdir**                        | Удаляет директорию                                                       |
| **rm** / **rip**                 | Удаляет файлы или директории                                             |
...
| **basename**                     | Извлечение имени из пути                                                 |
| **sha256sum** / **md5sum**       | Вычисление хеш-суммы                                                     |
| **lsof**                         | Показывает открытые файлы                                                |
| **realpath**                     | Показывает полный путь к файлу                                           |
| **readlink**                     | Показывает путь к файлу                                                  |
| **ln**                           | Создаёт символическую ссылку                                             |
| **dd**                           | Копирует блоки данных                                                    |


## Archive
| **tar**                          | Создаёт/распаковывает TAR-архивы                                         |
| **zip** / **unzip**              | Создаёт/распаковывает ZIP-архивы                                         |
| **gzip** / **gunzip**            | Создаёт/распаковывает GZIP-архивы                                        |
| **7z**                           | Создаёт/распаковывает 7ZIP-архивы                                        |
| **zgrep**                        | Поиск текста в архиве                                                    |
| **zless**                        | Просмотр текстового файла в архиве                                       |
| **zcat**                         | Просмотр текстового файла в архиве                                       |
...
| **yes**                          | Выводит строку несколько раз                                             |
| **tr**                           | Трансляция и замена символов в тексте                                    |


## Git
| **git**                          | Управление репозиторием Git                                              |
...
| **npm** / **fnm**                | Менеджер пакетов для node.js                                             |
| **ntl**                          | Interactive node task list                                               |
**npx** **yarn** **pnpm**


## NPX
| **gitignore**                    | Генератор .gitignore                                                     |
| **nodemon**                      | Перезапуск процесса при изменении кода                                   |
| **depcruise**                    | Проверка и визуализация зависимостей                                     |
| **json-server**                  | Сервер для работы с JSON-файлами                                         |
| **madge**                        | Проверка циклических зависимостей                                        |
| **kill-port**                    | Убивает процессы по номеру порта                                         |
| **serve**                        | Статичный сервер                                                         |
| **npkill**                       | Интерактивный поиск и удаление node_modules                              |
| **uuid**                         | Генератор UUID                                                           |
| **llm-checker**                  | Тестирование llm-моделей                                                 |
| **localtunnel**                  | Хостинг локальных серверов                                               |
| **qrcode**                       | Создаёт qr-коды                                                          |
| **wait-port**                    | Ожидание доступности порта                                               |
| **sort-package-json**            | Сортировка package.json                                                  |
| **npm-check-updates**            | Проверка обновлений пакетов                                              |
**tsc**
**eslint**
**prettier**
**cost-of-modules**
**check-unused-comp**
Был еще генератор лицензий, но не могу найти
...
| **lazydocker**                   | TUI-интерфейс для работы с Docker                                        |
...
| **ufw**                          | Управление веб-портами (Firewall)                                        |
| **service**                      | Управление службами, перенаправляет команды в системные сервисы          |
| **pgrep**                        | Поиск процессов по имени                                                 |
| **pwait**                        | Ожидание завершения процесса по имени                                    |
...
| **host** / **nslookup** / **dig** | Запрос DNS-информации                                                   |
| **nmcli**                        | Управление сетевыми интерфейсами (NetworkManager)                        |
| **arp**                          | Просмотр ARP-таблицы                                                     |
| **telnet** / *nc*                | Способ взаимодействия с удаленной системой через терминал, используя текстовые команды |
| **tcpdump**                      | Запись и просмотр сетевых пакетов                                        |
| **mitmproxy** / **mitmdump** / **mitmweb** | Прокси-сервер для перехвата HTTP-запросов                      |
| **ngrep**                        | Просмотр сетевых пакетов                                                 |


## Users
| **useradd** / **adduser**        | Добавление пользователя                                                  |
| **userdel** / **deluser**        | Удаление пользователя                                                    |
| **groupadd** / **addgroup**      | Добавление группы                                                        |
| **groupdel** / **delgroup**      | Удаление группы                                                          |
| **usermod**                      | Модификация пользователя (добавление в группу)                           |
| **groupmod**                     | Модификация группы                                                       |
| **passwd**                       | Изменение пароля пользователя                                            |
| **id** / **finger**              | Показывает информацию о пользователе                                     |
...
| **chage**                        | Управляет параметрами старения пароля                                    |
| **chmod**                        | Изменяет права доступа к файлам/директориям                              |
| **chgrp**                        | Изменяет группу для файлов/директорий                                    |
| **getent**                       | Показывает информацию о пользователях/группах                            |
| **last**                         | Показывает историю входа в систему                                       |
| **w** / **who**                  | Показывает кто в системе                                                 |
| **newgrp**                       | Переключает текущую группу                                               |
| **umask**                        | Устанавливает маску прав по умолчанию для новых файлов                   |
| **groups**                       | Показывает список групп пользователя                                     |


## SSH
| **ssh**                          | Подключение к удалённому серверу по SSH                                  |
| **ssh-copy-id**                  | Добавление ключа на удалённый сервер                                     |
| **sshpass**                      | Подключение к удалённому серверу по SSH с паролем                        |
| **scp**                          | Копирование файлов по SSH                                                |
| **sftp**                         | Перенос файлов по SSH                                                    |
...
## Commands
| **which**                        | Показывает путь к исполняемому файлу (ищет в PATH)                       |
| **whereis**                      | Ищет по бинарникам, man-файлы и документацию                             |
| **whatis**                       | Показывает документацию                                                  |
| **command**                      | Исполняет команду или показывает информацию о команде                    |
| **time**                         | Показывает время выполнения команды                                      |
...
| **disown**                       | Отсоединение процесса от терминала                                       |
...
| **lnav**                         | Просмотр логов                                                           |
| **update-ca-certificates**       | Обновление сертификатов для SSL                                          |
| **basenc** / **base32** / **base64** | Кодирование/декодирование данных                                     |
| **script**                       | Запись сессии терминала                                                  |
| **wall**                         | Отправка сообщений в чат                                                 |
...
## Env
| **direnv**                       | Управление окружением                                                    |
| **env**                          | Запуск программы с переменными окружения                                 |
...
| **sherlock**                     | Поиск аккаунтов в социальных сетях                                       |
...
| **!text**                        | Ищет команду в истории, которая начинается с указанного текста           |
| **!$**                           | Подставляет последний аргумент предыдущей команды                        |
| **^pre^new**                     | Заменяет вхождение в предыдущей команде                                  |

// dtelnet mkfifo seclists
