...
| **md5sum**                       | Подсчитывает контрольную сумму файла                                     |
...
**npx** **yarn** **tsc** **eslint** **prettier** **depcruise** **npm-check-updates** **cost-of-modules**
**serve** **json-server** **nodemon** **madge** **check-unused-comp** **npkill** **kill-port**
